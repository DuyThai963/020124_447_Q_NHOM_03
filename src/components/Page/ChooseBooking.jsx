                                                        ...
                                                        <div className="with-sidebar-left twelve columns">
                                                            <div className="with-sidebar-content twelve columns">
                                                                <div className="gdlr-item gdlr-item-start-content" id="gdlr-single-booking-content" data-ajax="https://demo.goodlayers.com/hotelmaster/wp-admin/admin-ajax.php">
                                                                    ...
                                                                    <div className="gdlr-booking-content gdlr-room-content">
                                                                        ...
                                                                        {/* </div>
                                                                        <div className="gdlr-booking-content-wrapp-all"> */}
                                                                        {roomList.map((room) => (
                                                                            <div className="gdlr-booking-content-wrapper">
                                                                                <div className="gdlr-booking-content-inner" id="gdlr-booking-content-inner" style={{ opacity: 1, height: 'auto' }}>
                                                                                    ...
                                                                                    <div className="gdlr-room-selection-complete">
                                                                                        <div className="gdlr-room-selection-title">Room Selection is Complete</div>
                                                                                        <div className="gdlr-room-selection-caption">You can edit your booking by using the panel on the left</div>
                                                                                        ...
                                                                                        <div className="gdlr-booking-service-wrapper">
                                                                                            <span className="gdlr-booking-service-head">Please select your preferred additional services. (optional)</span>


                                                                                            <form className="gdlr-booking-service-form" method="post">
                                                                                                {/* Wifi Option */}
                                                                                                <div className="gdlr-room-service-option" style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
                                                                                                    <label style={{ marginRight: '10px' }}>
                                                                                                        <input type="checkbox" />
                                                                                                    </label>
                                                                                                    <span style={{ marginRight: '400px', fontWeight: 'bold' }}>Wifi</span>
                                                                                                    <span style={{ color: '#888' }}>$14.00 / Room / Night</span>
                                                                                                </div>

                                                                                                {/* Car Park Option */}
                                                                                                <div className="gdlr-room-service-option" style={{
                                                                                                    display: 'flex',
                                                                                                    alignItems: 'center',
                                                                                                    marginBottom: '20px',
                                                                                                    ...
                                                                                                    <div style={{ display: 'flex', alignItems: 'center' }}>
                                                                                                        <label style={{ marginRight: '10px' }}>
                                                                                                            <input
                                                                                                                type="checkbox"
                                                                                                                checked={carParkSelected}
                                                                                                                onChange={(e) => setCarParkSelected(e.target.checked)}
                                                                                                            />
                                                                                                        </label>
                                                                                                        <span style={{ marginRight: '10px', fontWeight: 'bold' }}>Car Park</span>

                                                                                                        <select
                                                                                                            disabled={!carParkSelected}
                                                                                                            style={{
                                                                                                                width: '50px',
                                                                                                                height: '25px',
                                                                                                                padding: '0 5px',
                                                                                                                margin: '0 5px',
                                                                                                                backgroundColor: carParkSelected ? '#000' : '#f0f0f0',
                                                                                                                color: carParkSelected ? '#fff' : '#999',
                                                                                                                border: '1px solid #ddd',
                                                                                                                borderRadius: '4px',
                                                                                                                fontSize: '14px',
                                                                                                                cursor: carParkSelected ? 'pointer' : 'not-allowed'
                                                                                                            }}
                                                                                                            value={carParkAmount}
                                                                                                            onChange={(e) => setCarParkAmount(Number(e.target.value))}
                                                                                                        >
                                                                                                        ...
                                                                                                        <span style={{ marginRight: '260px' }}>Cars</span>
                                                                                                    </div>
                                                                                                    <span style={{ color: '#888', marginRight: '400px' }}>$9.00 / Car / Night</span>
                                                                                                </div>
                                                                                            </form>
                                                                                        ...
                                                                                        <Button className="gdlr-button with-border gdlr-room-selection-next" onClick={(e) => handleBooking(e, room)}  >Go to next step</Button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
