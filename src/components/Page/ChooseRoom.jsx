                                                            ...
                                                            <div className="with-sidebar-content twelve columns">
                                                                <div className="gdlr-item gdlr-item-start-content" id="gdlr-single-booking-content" data-ajax="https://demo.goodlayers.com/hotelmaster/wp-admin/admin-ajax.php">
                                                                    ...
                                                                    <div className="gdlr-booking-content-wrapp-all">
                                                                        {roomList.map((room) => (
                                                                            <div
                                                                                className="gdlr-booking-content-wrapper gdlr-choose-room-content-wrapper">
                                                                                <div className="choose-romm-content-image">
                                                                                    <img src="/image/room_1.jpg"
                                                                                         className="choose-romm-content-image-img"
                                                                                         alt="Room"/>
                                                                                </div>
                                                                                <div className="choose-romm-content-text">
                                                                                    <h3 className="gdlr-room-title-custom">{room?.room_name }</h3>
                                                                                    <div className="gdlr-hotel-room-info">
                                                                                        <div className="gdlr-room-info"><i
                                                                                            className="fa fa-check-square-o icon-check"></i><span
                                                                                            className="gdlr-head">Bed</span><span
                                                                                            className="gdlr-tail">1 King Bed</span>
                                                                                        </div>
                                                                                        <div className="gdlr-room-info"><i
                                                                                            className="fa fa-check-square-o icon-check"></i><span
                                                                                            className="gdlr-head">Max</span><span
                                                                                            className="gdlr-tail">3 People</span>
                                                                                        </div>
                                                                                        <div className="gdlr-room-info"><i
                                                                                            className="fa fa-check-square-o icon-check"></i><span
                                                                                            className="gdlr-head">View</span><span
                                                                                            className="gdlr-tail">City</span>
                                                                                        </div>
                                                                                        <div className="clear"></div>
                                                                                    </div>
                                                                                    <div
                                                                                        className="gdlr-room-content-custom">
                                                                                        Cras justo odio, dapibus ac
                                                                                        facilisis in, egestas eget quam. Sed
                                                                                        posuere consectetur est at lobortis.
                                                                                        Nullam quis risus eget urna mollis
                                                                                        ornare vel eu leo. Cum sociis
                                                                                        natoque penatibus et magnis dis
                                                                                        parturient montes, nascetur
                                                                                        ridiculus mus. Cras justo odio,
                                                                                        dapibus ac facilisis in, egestas
                                                                                        eget quam. Maecenas sed diam eget
                                                                                        risus varius blandit sit amet non
                                                                                        magna. Nulla vitae elit libero, a
                                                                                        pharetra augue. Maecenas faucibus
                                                                                        mollis interdum. Donec id elit non
                                                                                        mi porta gravida at eget metus.
                                                                                        Vestibulum id ligula porta felis
                                                                                        euismod semper. Maecenas faucibus
                                                                                        mollis interdum. Donec ullamcorper
